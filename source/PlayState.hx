...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
            ...
            case 'tormentor': //Week 1
				var bg:BGSprite = new BGSprite('TormentorBG', -500, -325, 0.9, 0.9);
				add(bg);
				
				var bg2:BGSprite = new BGSprite('TormentorStatic',225, -70 , 0.9, 0.9, [Tormentor Static], true);
				add(bg2);
